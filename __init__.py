                ...
                CONF_CORES: [
                    vol.All(
                        ...
                        ),
                        {
                            ...
                            vol.Optional(USE_ZONES_AS_AREAS): cv.boolean,
                            vol.Optional(USE_CATEGORIES_AS_LABELS): cv.boolean,
                            vol.Optional(
...
async def _setup_core(
    ...
    use_zones_as_areas = _read_from_config_or_default(
        core_config, USE_ZONES_AS_AREAS, False
    )
    use_categories_as_labels = _read_from_config_or_default(
        core_config, USE_CATEGORIES_AS_LABELS, False
    )
