...
| `id` | string | **Required when multiple core is used.** String identifier of core. Use any like `appartment_8` or `primary`. |
| `api_url` | string | API URL of your core `http://192.168.1.3/api/TapHomeApi/v1`. |
| `webhook_id` | string | Register a webhook for push updates in Home Assistnat e.g. `taphome_primary`. |
