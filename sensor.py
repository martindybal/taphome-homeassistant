...
class TapHomeSensorType:
    ...
    convert_taphome_to_ha: Callable[
...
WIND_SPEED_SENSOR = TapHomeSensorType(
    ...
    convert_taphome_to_ha=lambda v: round(v, 1),
)
...
ANALOG_INPUT_SENSOR = TapHomeSensorType(
    ...
    state_class=SensorStateClass.MEASUREMENT,
    convert_taphome_to_ha=TapHomeEntity.convert_th_percentage_to_ha,
)
...
class TapHomeSensor(TapHomeEntity, SensorEntity):
    ...
    def _on_device_state_change(
        ...
        self._attr_native_value = (
            None if value is None else self._sensor_type.convert_taphome_to_ha(value)
        )
